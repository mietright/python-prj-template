...
def create_app():
    ...
    if setting != 'production':
        app.config.from_object('{{ cookiecutter.project_slug }}.api.config.DevelopmentConfig')
    else:
        app.config.from_object('{{ cookiecutter.project_slug }}.api.config.ProductionConfig')
